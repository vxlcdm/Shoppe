...
import { Card,Switch, FormControlLabel,Paper,  AppBar, Toolbar,Container,CardContent, CardActions, Avatar, Typography, Button, Grid, Divider, Box  } from "@mui/material";
...
const Profile = () => {
    ...
    return (
        ...
        <Box
                    ...
                    {user ? `${user.name.title}  ${user.name.name.toUpperCase()}` : "loading"}'s Profile
                        </Typography>
